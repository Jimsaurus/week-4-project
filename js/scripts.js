...
$(document).ready(function(){
	...
	$('input[type="submit"]').on('click', function(e){
		...
		if (typeof answer1 === 'undefined' ||
			...
			alert('Whoops! You missed a question or two!  Please try again!');
		} else{
			...
			// }
				...
				$resultsDesc.text("One facial hair style to rule them all! This style has been known to cause a person to spontaneously clap, \"woo\" and chant \"JavaScript, JavaScript\".");
			}
